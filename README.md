...
|---|---|---|
| `midil[auth]` | httpx, pyjwt | Cognito auth, JWT verification, HTTP client |
| `midil[web]` | fastapi, starlette, uvicorn | REST APIs, middleware, pagination |
| `midil[aws]` | aioboto3 | SQS consumers, EventBridge scheduling |
| `midil[redis]` | redis | Redis-backed event streaming |
| `midil[mongodb]` | pymongo | MongoDB cursor pagination |
| `midil[cli]` | click, rich, cookiecutter | Project scaffolding and service launcher |
| `midil[full]` | everything | — |
